...
| Threat                      | Mitigation                                                                                                                                                                                                                                                                                                        |
| --------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Malicious agent output      | Text fields render as **escaped plain text**, so embedded HTML never executes. The one HTML field — an explanation's `diagram_html` — is **sanitized server-side with `ammonia`** on write (scripts, event handlers, and unsafe URLs stripped; only safe markup is stored), and the strict CSP is a second layer. |
