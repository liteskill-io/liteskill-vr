# LiteSkill VR — Specification

A structured notebook for reverse engineering research. Tauri + TypeScript desktop app that hosts an MCP server so AI agents can read and write research data.
